    ...
    return (
        <>
            <div className="flex flex-col space-y-4">
                <h2 className='text-xl lg:text-3xl xl:text-4xl font-bold py-2'>
                    {product.name || 'N/A'}
                </h2>
                <div>
                    ...
                    <div className="flex flex-col space-y-2 text-lg my-8">
                        {
                            ...
                            :
                            <Link href="/cart" className="py-3 flex justify-center items-center w-64 bg-green-600 h-auto text-white rounded-lg border-2 border-white">
                                Buy now
                            </Link>
                        }
                    </div>
