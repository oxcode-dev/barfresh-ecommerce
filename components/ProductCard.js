        ...
        <>
            <div className="w-full bg-white border border-gray-200 rounded-lg shadow product-card">
                ...
                <div href="#">
                    <div className="p-5">
                        <a href="#">
                            <p className="mb-2 text-xl font-medium tracking-tight text-gray-700">
                                Shea Butter
                            </p>
                        </a>
                        ...
                        <div className="flex space-x-2 items-center justify-between mt-2">
                            <p className="text-green-700 text-xl">£ 100</p>
                            <a href="#" className="cart-btn space-x-1 items-center px-3 py-2 text-sm font-medium text-center shadow border border-green-600 bg-white rounded text-green-600 focus:outline-none">
                                <p>Add to cart</p>
